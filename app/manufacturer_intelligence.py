"""Evidence-limited manufacturer intelligence for the canonical expansion.

This module is deliberately separate from the governed Board Master.  The
release-ready manufacturers have canonical model identities and standard sizes, but
...
def load_manufacturer_expansion_catalogue() -> dict:
    """Load the deployable canonical snapshot, or a safe empty snapshot."""
