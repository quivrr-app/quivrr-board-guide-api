...
- Deployment: API commits `2e4a088`, `0078b99` and `b00c7c6` were pushed to `master`; final Azure package deployment `298caee0-1497-4eb7-96fb-35a9a3644511` completed `RuntimeSuccessful`. Production smoke confirmed natural card-free fish/tail explanations and acknowledgements; correction and sign-in events are card-free; explicit recommendation, regional topic pivot, active-board Indonesia availability and beginner safety still follow their governed routes.
